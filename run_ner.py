...
Fine-tune the model for BERT CNER.
...
from batterybert.finetune import BertCrfForTokenClassification, BertLstmCrfForTokenClassification
from batterybert.finetune import conlleval
